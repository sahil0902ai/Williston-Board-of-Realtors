            ...
            <>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <button 
                        ...
                        className="absolute top-0 right-0 h-full w-12 flex items-center justify-center text-gray-500 hover:text-white"
                        suppressHydrationWarning
                        style={{
                          minHeight: '44px',
                          cursor: 'pointer',
                    ...
                    <div className="flex justify-between gap-3 max-w-[200px]">
                      {pin.map((digit, idx) => (
                        <input
                          ...
                          className="w-11 h-11 bg-[#04091A] rounded-xl border border-white/5 focus:border-gold focus:outline-none text-center text-lg font-bold text-white"
                          suppressHydrationWarning
                          style={{
                            touchAction: 'manipulation',
                          }}
              ...
              {step === 3 && (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-2">
                    <label 
                      className="flex items-start gap-2.5 cursor-pointer text-xs select-none text-gray-text hover:text-white"
                      style={{
                        minHeight: '44px',
                        display: 'inline-flex',
              ...
              {/* Bottom Login Prompt */}
              <div className="mt-8 text-center text-sm border-t border-white/5 pt-4 flex flex-wrap items-center justify-center gap-1">
