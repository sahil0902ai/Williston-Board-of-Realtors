  ...
  return (
    <header className="h-20 bg-[rgba(4,9,26,0.97)]  border-b border-border-subtle sticky top-0 z-30 flex items-center justify-between px-6 lg:px-10">
      <div className="flex items-center gap-4">
        <button 
          className="lg:hidden w-10 h-10 rounded-full bg-navy-light flex items-center justify-center text-white"
          onClick={onMenuClick}
        >
          <Menu size={20} />
        </button>
      ...
      <div className="flex items-center gap-4 md:gap-6">
        <button className="relative p-2 text-gray-text hover:text-white transition-colors">
          <Bell size={20} />
